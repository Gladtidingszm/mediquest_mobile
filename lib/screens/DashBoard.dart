          ...
          [
            Container
              ...
              child: Row
                ...
                children: <Widget>
                [
                  Text('gladtidings.com', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('Total Submissions', style: TextStyle(color: Colors.blueAccent)),
                ...
                child: Column
                  (
                    ...
                    [
                      ...
                      Text('Schools', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                      Text('Universities', style: TextStyle(color: Colors.black45)),
                    ]
                ),
              ),
            ),
                      ...
                      Row
                        ...
                        [
                          Column
                            ...
                            children: <Widget>
                            [
                              Text('Marks', style: TextStyle(color: Colors.green)),
                              Text('160', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                            ],
                          ),
                          DropdownButton
                            (
                  ...
                  (
                    ...
                    [
                      Column
                        ...
                        children: <Widget>
                        [
                          Text('All', style: TextStyle(color: Colors.redAccent)),
